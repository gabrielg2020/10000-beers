...
export class ImageService {
	...
	constructor() {
		this.storagePath = config.storage.imagePath;
		this.maxSizeMB = config.storage.maxImageSizeMB;
	}
	...
	validateImage(buffer: Buffer, mimetype: string): ImageValidationResult {
		// Validate mimetype
